...
const LEVELS: Array[String] = ["street", "park", "beach", "rain", "market", "oldtown", "trail"]
const LEVEL_NAMES := {
	"daily": "Daily Walk",
	"street": "The Boulevard", "park": "The Park",
	"beach": "Passeig Maritim", "rain": "El Aguacero", "market": "El Mercat",
	"oldtown": "El Gotic", "trail": "El Bosc",
}
...
const STAR_GATE := {"street": 0, "park": 2, "beach": 4, "rain": 5, "market": 7, "oldtown": 9, "trail": 11}
...
const CAROUSEL: Array[String] = ["daily", "street", "park", "beach", "rain", "market", "oldtown", "trail"]
