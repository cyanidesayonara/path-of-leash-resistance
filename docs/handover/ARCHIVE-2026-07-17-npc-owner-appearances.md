# ARCHIVE — Path of Leash Resistance handover (2026-07-17)

**Archived.** Historical sitrep from the NPC owner-appearances / post-v1.5
lifecycle era. Not current truth. For the live pointer see `HANDOVER.md`
at the repo root (v1.53 hardening sitrep).

---

# HANDOVER — Path of Leash Resistance (historical)

A complete brief for another AI agent (or human) picking up this project
as of mid-July 2026. Prefer root `HANDOVER.md`, `AGENTS.md`, `PROJECT.md`,
